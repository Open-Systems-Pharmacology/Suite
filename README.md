...
[![Setup status](https://img.shields.io/github/actions/workflow/status/Open-Systems-Pharmacology/Suite/build-and-publish.yml?logo=nuget&label=Suite%20Setup)](https://github.com/Open-Systems-Pharmacology/Suite/actions/workflows/build-and-publish.yml)  [![PK-Sim status](https://img.shields.io/github/actions/workflow/status/Open-Systems-Pharmacology/PK-Sim/build-nightly_12.2.yml?logo=nuget&label=PK-Sim)](https://github.com/Open-Systems-Pharmacology/PK-Sim/actions/workflows/build-nightly_12.2.yml)  [![MoBi status](https://img.shields.io/github/actions/workflow/status/Open-Systems-Pharmacology/MoBi/build-nightly_12.2.yml?logo=nuget&label=MoBi)](https://github.com/Open-Systems-Pharmacology/MoBi/actions/workflows/build-nightly_12.2.yml)  [![Installation Validator status](https://img.shields.io/github/actions/workflow/status/Open-Systems-Pharmacology/InstallationValidator/build-nightly.yml?logo=nuget&label=Installation%20Validator)](https://github.com/Open-Systems-Pharmacology/InstallationValidator/actions/workflows/build-nightly.yml)  [![Qualification Runner status](https://img.shields.io/github/actions/workflow/status/Open-Systems-Pharmacology/QualificationRunner/build-nightly.yml?logo=nuget&label=Qualification%20Runner)](https://github.com/Open-Systems-Pharmacology/QualificationRunner/actions/workflows/build-nightly.yml)
